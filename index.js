...
//q = popular videos --> popular%20Videoa  (%20 - space)
let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=popular%20videos&type=video&key=AIzaSyA00OxUbfdfVAjHn-9l48s0t-n_j7CBbNs&maxResults=25`);
...
//search for videos
let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=${query}&type=video&key=AIzaSyDn4gg8RFaGibKyK0fj2jtvDodYausAMrw&maxResults=25`);
let data = await res.json();
...
// AIzaSyDn4gg8RFaGibKyK0fj2jtvDodYausAMrw
